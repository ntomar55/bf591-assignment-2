...
# Assignment
Using what you know from this document and the `main.R` script, use the functions from `main.R` to draw a boxplot of  expression levels. Use this R Markdown document to describe your code as you are using it in this document, as done above. Take time to enhance your ggplot function from the `main.R` script with high quality visual aesthetics. Do not use default ggplot colors.
