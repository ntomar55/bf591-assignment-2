...
# Assignment
Using what you know from this document and the `main.R` script, use the functions from `main.R` to draw a box plot of  expression levels. You may wish to use the markdown conventions above to describe your code. Take time to enhance your ggplot function from the `main.R` script and do not use default ggplot colors.
```{r Assignment chunk, echo=FALSE}
...
# fill in the blanks here to process and plot your data
samples <- 
sample_names <- 
